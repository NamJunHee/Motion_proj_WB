...
C_SRCS += \
../Core/Src/backup/main.c 

OBJS += \
./Core/Src/backup/main.o 

C_DEPS += \
./Core/Src/backup/main.d 
...
clean-Core-2f-Src-2f-backup:
	-$(RM) ./Core/Src/backup/main.cyclo ./Core/Src/backup/main.d ./Core/Src/backup/main.o ./Core/Src/backup/main.su
